...
expName = 'tSwitchTest1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\tSwitchTest1\\tSwitchTest1_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='fullRandom', 
    ...
    trialList=data.importConditions('tSwitchCond1.xlsx'),
...
for thisTrial in trials:
    ...
    _key_resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [trialGrid, trialShape, key_resp]
